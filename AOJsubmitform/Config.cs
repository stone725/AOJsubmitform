...
namespace AOJsubmitform
{
  public class Config
  {
    ...
    public void Load()
    {
      ...
      {
        StreamReader configFileReader = new StreamReader("txt");
      ...
      else if (File.Exists("Twittertxt"))
      {
        StreamReader twitterConfigFileReader = new StreamReader("Twittertxt");
